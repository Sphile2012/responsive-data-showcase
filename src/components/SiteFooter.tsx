...
export function SiteFooter() {
  return (
    <footer className="mt-20" style={{ borderTop: "1px solid rgba(34,211,238,0.08)" }}>
      <div style={{ background: "rgba(8,10,28,0.6)", backdropFilter: "blur(16px)" }}>
        <div className="mx-auto max-w-7xl px-6 lg:px-10 py-12 grid gap-10 md:grid-cols-3">
          ...
          <div>
            ...
            >
              Data analyst turning messy datasets into decisions. Based in Johannesburg, open to
        ...
        {/* Bottom bar */}
        <div className="py-5 text-center" style={{ borderTop: "1px solid rgba(34,211,238,0.06)" }}>
          <p className="text-xs" style={{ color: "#334155", fontFamily: "'Inter', sans-serif" }}>
            © {new Date().getFullYear()} Teddy Mathabatha ·{" "}
            <span style={{ color: "#22d3ee" }}>Data Analyst</span> · Johannesburg, South Africa
          </p>
        </div>
      </div>
    </footer>
