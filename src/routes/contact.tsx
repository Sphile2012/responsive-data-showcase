...
import { Github, Linkedin, Mail, MapPin, Phone, Send, ArrowRight, Clock, Wifi, Globe } from "lucide-react";
  ...
  return (
    <div className="overflow-x-hidden">
      ...
      <div className="relative border-b overflow-hidden" style={{ borderColor: "rgba(34,211,238,0.1)" }}>
        ...
        <div className="absolute top-0 right-0 w-80 h-80 rounded-full blur-[120px] opacity-10"
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-10 py-16 lg:py-24 relative">
          <div className="grid lg:grid-cols-12 gap-12 items-center">
            ...
            >
              <p className="font-mono text-xs uppercase tracking-[0.25em]" style={{ color: "#22d3ee" }}>Get In Touch</p>
              <h1
                className="font-hero uppercase leading-none"
                style={{ fontSize: "clamp(2.8rem, 8vw, 6rem)", background: "linear-gradient(135deg, #00e5ff, #7c3aed)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}
              >
                Let's Talk Data.
              </h1>
              <p className="text-base lg:text-lg leading-relaxed" style={{ color: "#94a3b8", fontFamily: "'Inter', sans-serif" }}>
                Whether it's a dashboard, a quick query, or a longer engagement — I'd love to hear what you're working on and how data can unlock the answers.
              </p>
              ...
              <a
                ...
                style={{ background: "linear-gradient(135deg, #22d3ee, #7c3aed)", color: "#fff", boxShadow: "0 0 28px rgba(34,211,238,0.3)" }}
              >
            ...
            >
              ...
              >
                ...
                <div className="flex items-center gap-2 mb-6 pb-5" style={{ borderBottom: "1px solid rgba(34,211,238,0.1)" }}>
                  ...
                  <span className="ml-2 font-mono text-[10px] uppercase tracking-widest" style={{ color: "#64748b" }}>availability_status.json</span>
                </div>
                ...
                >
                  <span className="size-2.5 rounded-full animate-pulse" style={{ background: "#34d399", boxShadow: "0 0 10px #34d399" }} />
                  <div>
                    <p className="font-poppins font-semibold text-sm" style={{ color: "#34d399" }}>Available for New Opportunities</p>
                    <p className="text-xs mt-0.5" style={{ color: "#64748b", fontFamily: "'Inter', sans-serif" }}>Open to Data Analyst & Data Science roles</p>
                  </div>
                </div>
                  ...
                  {statusRows.map(r => (
                    ...
                    >
                      ...
                      <div className="flex-1">
                        <p className="font-mono text-[9px] uppercase tracking-widest" style={{ color: "#475569" }}>{r.label}</p>
                        <p className="text-sm font-medium mt-0.5" style={{ color: "#cbd5e1", fontFamily: "'Inter', sans-serif" }}>{r.value}</p>
                      </div>
                    </div>
                  ))}
                </div>
                ...
                {/* Quick links */}
                <div className="grid grid-cols-2 gap-2 mt-5 pt-5" style={{ borderTop: "1px solid rgba(255,255,255,0.05)" }}>
                  <a href="https://github.com/TeddyDataHub" target="_blank" rel="noopener noreferrer"
                    ...
                    style={{ background: "rgba(167,139,250,0.08)", border: "1px solid rgba(167,139,250,0.2)", color: "#a78bfa", fontFamily: "'Inter', sans-serif" }}
                  >
                    <Github className="size-4" /> GitHub
                  </a>
                  <a href="https://www.linkedin.com/in/teddy-mathabatha-3ba205223/" target="_blank" rel="noopener noreferrer"
                    className="flex items-center justify-center gap-2 py-2.5 rounded-lg text-sm font-medium transition-all duration-200 hover:-translate-y-0.5"
                    style={{ background: "rgba(244,114,182,0.08)", border: "1px solid rgba(244,114,182,0.2)", color: "#f472b6", fontFamily: "'Inter', sans-serif" }}
                  >
      ...
      <div className="mx-auto max-w-4xl px-6 lg:px-10 py-16 space-y-10">
          ...
          {channels.map((c, i) => (
            ...
            >
              <div className="flex items-start justify-between mb-4">
                <div className="size-11 rounded-xl grid place-items-center transition-transform duration-300 group-hover:scale-110"
                  style={{ background: `${c.color}15`, border: `1px solid ${c.color}25` }}>
                  <c.icon className="size-5" style={{ color: c.color }} />
                </div>
                <ArrowRight className="size-4 -translate-x-1 opacity-0 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300"
                  style={{ color: c.color }} />
              </div>
              <p className="font-mono text-[10px] uppercase tracking-widest mb-1" style={{ color: "#64748b" }}>{c.label}</p>
              <p className="font-semibold text-sm break-all mb-2" style={{ color: "#e2e8f0", fontFamily: "'Inter', sans-serif" }}>{c.value}</p>
        ...
        <motion.div
          ...
          style={{ background: "linear-gradient(135deg, rgba(14,18,42,0.95), rgba(20,10,40,0.95))", backdropFilter: "blur(24px)", border: "1px solid rgba(34,211,238,0.12)" }}
        >
          ...
          <div className="relative">
            <div className="size-14 rounded-2xl grid place-items-center mx-auto mb-5"
              style={{ background: "rgba(34,211,238,0.1)", border: "1px solid rgba(34,211,238,0.2)" }}>
              <Send className="size-6" style={{ color: "#22d3ee" }} />
            </div>
            <h2 className="font-montserrat font-bold text-2xl md:text-3xl mb-3" style={{ color: "#f1f5f9" }}>Have a Dataset That Needs Answers?</h2>
            ...
            <a
              ...
              style={{ background: "linear-gradient(135deg, #00e5ff, #7c3aed)", color: "#fff", boxShadow: "0 0 32px rgba(34,211,238,0.25)" }}
            >
