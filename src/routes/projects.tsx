  ...
  head: () => ({
    meta: [
      { title: "Projects & Case Studies — Teddy Mathabatha" },
      {
        name: "description",
        content:
          "Detailed data analysis and data science case studies — pharmacy retail analytics, HIV epidemiology dashboards, and data quality engineering.",
      },
    ],
  }),
...
const cases: CaseStudy[] = [
  {
    ...
    methods:
      "Built an Excel + SQL pipeline: standardised schemas with Power Query, deduplicated on transaction key, joined product master data, then computed YoY, MoM, and per-region growth in SQL CTEs.",
  ...
  },
  {
    ...
    methods:
      "Modelled a star schema in Power BI (fact: indicators, dims: province × year × indicator-type). Authored DAX measures for YoY change, gap-to-target, and percentile rank.",
  ...
  },
  {
    ...
    methods:
      "Profiled every column with SQL and Python (pandas), defined business-friendly names + data dictionaries, mapped source → staging → mart transformations, and classified quality issues.",
  ...
  return (
    <div className="overflow-x-hidden">
      ...
      >
        ...
        <div
          className="absolute top-0 left-1/3 w-80 h-80 rounded-full blur-[120px] opacity-10"
          style={{ background: "radial-gradient(circle, #22d3ee, transparent 70%)" }}
        />
        <div
          className="absolute bottom-0 right-0 w-64 h-64 rounded-full blur-[100px] opacity-10"
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-10 py-16 lg:py-24 relative">
          <div className="grid lg:grid-cols-12 gap-12 items-center">
            ...
            >
              ...
              >
                Each case study walks through the problem, the data, the methods, the tools — and
                the measurable impact delivered. Source code lives on GitHub.
              </p>
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-3 mb-6">
                  {portfolioMetrics.map((m) => (
                    ...
                    >
                      ...
                      <p className="font-orbitron font-bold text-lg" style={{ color: m.color }}>
                        {m.value}
                      </p>
                      <p
                ...
                <div className="space-y-2">
                  {cases.map((c, i) => (
                    ...
                    >
                      <span
                        className="font-orbitron text-xs font-bold w-6"
                      ...
                      <span
                        ...
                        style={{ background: c.accentColor, boxShadow: `0 0 6px ${c.accentColor}` }}
                      />
                    </div>
                  ))}
                </div>
          ...
          >
            <div className="lg:col-span-7 space-y-6">
              ...
              <div className="space-y-5">
                <CaseRow icon={Target} label="Problem" accentColor={c.accentColor}>
                  {c.problem}
                </CaseRow>
                <CaseRow icon={DbIcon} label="Data" accentColor={c.accentColor}>
                  {c.data}
                </CaseRow>
                <CaseRow icon={Wrench} label="Methods" accentColor={c.accentColor}>
                  {c.methods}
                </CaseRow>
              ...
              <div className="flex flex-wrap gap-3 pt-1">
                {c.github && (
                  <a
                    ...
                    onMouseEnter={(e) => {
                      (e.currentTarget as HTMLElement).style.color = c.accentColor;
                      (e.currentTarget as HTMLElement).style.borderColor = `${c.accentColor}60`;
                    }}
                    onMouseLeave={(e) => {
                      (e.currentTarget as HTMLElement).style.color = "#94a3b8";
                      (e.currentTarget as HTMLElement).style.borderColor = `${c.accentColor}25`;
                    }}
                  >
            ...
            <div className="lg:col-span-5">
              ...
              >
                ...
                <p
                  className="text-xs text-muted-foreground mt-4 leading-relaxed border-t pt-3"
                  style={{ borderColor: `${c.accentColor}15` }}
                >
                  {c.chartCaption}
                </p>
              </div>
  ...
  return (
    <div className="flex gap-4">
      ...
      <div className="flex-1 min-w-0">
        ...
        <div
          className="text-foreground/85 leading-relaxed text-sm"
